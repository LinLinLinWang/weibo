	  ...
	  $.ajax({ 
	    ...
	    success:function(data){ 
	    	if(data.state==0)
	    		...
	    		window.parent.location.href='/ssm_grimm/ajax/showAllPosting.mvc';
						...
						<div class="table-responsive" style="width:100%; height:100%">
							<table class="table table-striped table-bordered table-hover"
								...
								<tbody>
	                              ...
	                              <c:forEach items="${allPost}" var="info">
										...
										<tr class="odd gradeX">
											 ...
											 <td>${info.content}</td>
											  <td>${info.time}</td>
					                           ...
					                           <td onclick='deletePost(${info.id});'>删除</td>
